 ...
 */
// generated on 2018-01-26 using generator-openmrs-owa 0.6.0
'use strict';
...
const THIS_APP_ID = 'modulo-prueba-openmrs';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      'LOCAL_OWA_FOLDER': '/home/oscar/openmrs-standalone-2.4/appdata/owa/',
	      'APP_ENTRY_POINT': 'http://localhost:8081/openmrs-standalone/owa/modulo-prueba-openmrs/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/modulo-prueba-openmrs`,
	  css: `${__dirname}/app/css/modulo-prueba-openmrs.css`,
	  vendor : [
